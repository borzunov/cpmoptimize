#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""This is a testcase for original xrange from Python 2.6.9 source code.
It is used to test cpmoptimize.xrange. The new version supports long numbers,
hence tests for OverflowError are removed.
"""
